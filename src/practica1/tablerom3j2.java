...
public class tablerom3j2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Title.setText("MODALITY 3");
    ...
    private void ganador(int n){
        if(n==0){
            if(player == false){JOptionPane.showMessageDialog(null, "El perdedor es el jugador 1");}
            if(player == true) {JOptionPane.showMessageDialog(null, "El perdedor es el jugador 2");}
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tablerom3j2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tablerom3j2().setVisible(true);
            }
        });
    }
