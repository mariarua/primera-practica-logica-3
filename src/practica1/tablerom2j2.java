...
public class tablerom2j2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Title.setText("MODALITY 2");
    ...
    private void btn_fila1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_fila1MouseClicked
        ...
        if(condicion()){
            ...
            JOptionPane.showMessageDialog(null, "No puede retirar mas fichas");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tablerom2j2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tablerom2j2().setVisible(true);
            }
        });
    }
